...
with st.sidebar:
    ...
    - **The Daily Drucker (2004)** - 366 daily insights on management, leadership, and innovation
    - **The Effective Executive (2002)** - Habits and practices for executive effectiveness
    - **The Essential Drucker (2008)** - Curated collection of Drucker's foundational principles
    ## 💡 Example Questions
    - What did Drucker say about knowledge workers?
    - What are Drucker's views on innovation?
    - Who is Peter Drucker?
    
    **The assistant can also search the web for additional information related to Peter Drucker's work.**
    """)
    st.markdown("""----""")
